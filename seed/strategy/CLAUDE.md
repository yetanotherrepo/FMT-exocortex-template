...
Каждый репозиторий в `/Users/ds/Documents/IWE/` содержит `WORKPLAN.md` в корне с текущими РП.

**Агрегация:** При создании плана дня/недели Стратег:
1. Обходит все `/Users/ds/Documents/IWE/*/WORKPLAN.md`
...
for repo in $(ls /Users/ds/Documents/IWE/); do
  if [ -d /Users/ds/Documents/IWE/$repo/.git ]; then
    echo "=== $repo ===" && cd /Users/ds/Documents/IWE/$repo && git log --oneline --since="1 week ago" 2>/dev/null
  fi
done
```
...
> **Полное описание:** `/Users/ds/Documents/IWE/CLAUDE.md` секция 2.
