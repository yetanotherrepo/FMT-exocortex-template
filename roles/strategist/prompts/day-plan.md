...
2. Для каждого события:
   ...
   - Сопоставь с РП из WeekPlan по теме/проекту
   - Если встреча без РП — предложи связь или новый РП
3. Рассчитай занятое время → скорректируй дневной бюджет
4. Включи секцию в DayPlan (только если есть встречи)
...
| Время | Встреча | Длительность | Связь с РП |
|-------|---------|--------------|------------|
| HH:MM–HH:MM | Название | Xч | #N РП / предлагаю связать с #N / — |
