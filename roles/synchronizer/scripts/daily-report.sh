...
LOG_DIR="/Users/ds/logs/synchronizer"
STRATEGY_DIR="/Users/ds/Documents/IWE/DS-strategy"

# Agent Workspace: если существует — отчёты идут туда
AGENT_WORKSPACE="/Users/ds/Documents/IWE/DS-agent-workspace"
...
STRATEGIST_LOG="/Users/ds/logs/strategist/$DATE.log"
...
"
        if echo "$warnings" | grep -q "push failed" 2>/dev/null; then
            report+="- **push failed:** Mac был оффлайн. Запусти \`cd /Users/ds/Documents/IWE/DS-strategy && git pull --rebase && git push\`
"
        fi
    else
        report+="
